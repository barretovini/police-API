...
import com.gft.crime.api.controllers.dto.TokenDTO;
import com.gft.crime.api.controllers.form.AutenticacaoForm;
...
public class AutenticacaoService {
	...
	public TokenDTO autenticar(AutenticacaoForm authForm) throws AuthenticationException {
		...
		Authentication authenticate = authManager.authenticate(new UsernamePasswordAuthenticationToken(authForm.getNomeUsuario(), authForm.getSenha()));
